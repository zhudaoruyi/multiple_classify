...
model.compile(optimizer='adam', loss=['binary_crossentropy'], metrics=[multi_acc])

csvlogger = CSVLogger('log10032100_01.log', append=True)
model_check = ModelCheckpoint('model10032100_01_p.h5', monitor='val_loss', save_best_only=True)
